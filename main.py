...
def show_menu(event):
    #display the menu at the mouse positon
...
Label(root,image=logo_image,bg="#0099ff").place(x=300,y=57)

#heading
heading=Label(root,text="BOOK RECOMMENDATION",font=("Lato",30,"bold"),bg="white",fg="#0099ff")
heading.place(x=410,y=70)
...
setting=Button(root,image=Setting_image,bg="#0099ff",bd=0,activebackground="#0099ff",cursor="hand2")
...
Button(root,image=Logout_image,bg="#0099ff",bd=0,activebackground="#0099ff",cursor="hand2",command=lambda: root.destroy()).place(x=1150,y=20)
...
#published date
text2={'a11':Label(frame11,text="Date",font=("arial",10),fg="red",bg="#e6e6e6"),
       'a22':Label(frame22,text="Date",font=("arial",10),fg="red",bg="#e6e6e6"),
       'a33':Label(frame33,text="Date",font=("arial",10),fg="red",bg="#e6e6e6"),
       'a44':Label(frame44,text="Date",font=("arial",10),fg="red",bg="#e6e6e6"),
       'a55':Label(frame55,text="Date",font=("arial",10),fg="red",bg="#e6e6e6")}
